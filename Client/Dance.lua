...
RegisterCommand('dance', function(source, args)
  local danceNum = tonumber(args[1])

  if danceNum == nil or danceNum <= 0 then
    danceNum = math.random(1, #DanceAnimations)
  end

  LoadAnim(DanceAnimations[danceNum].dict)
  TaskPlayAnim(PlayerPedId(), DanceAnimations[danceNum].dict, DanceAnimations[danceNum].anim, 3.0, 3.0, -1, 1, 0, 0, 0, 0)
end)